...
public class Customer {
	...
	public static void updateCustomerData(String FirstName,String LastName,String EmailAdress, String NewStreet,
		...
		String streetAdress=NewStreet;
		
		String sql = "update  customers set streetadress="+"\'"+streetAdress+"\'"
